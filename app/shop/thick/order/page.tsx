...
export default function ThickOrderPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const body = {
        _subject: "Purchase Inquiry: THICK Candleholder",
        _replyto: email,
        product: "THICK Candleholder",
        quantity: qty,
      ...
      <main className="px-5 md:px-[100px] pt-[90px] pb-24 min-h-screen flex flex-col justify-center">
        <div className="max-w-md">
          ...
          <p className="text-[0.78rem] leading-[2] text-[#888] mb-8">
            We have received your inquiry for the THICK Candleholder. We will get
    ...
    <main className="px-5 md:px-[100px] pt-[90px] pb-24">
      ...
      <div className="pt-10 pb-10 border-b border-[#DCDAD5]">
        <p className="text-[0.6rem] tracking-[0.12em] text-[#888] uppercase mb-4">
          ...
          {" / "}
          <Link href="/shop/thick" className="hover:text-[#2222FF] transition-colors">
            THICK Candleholder
          </Link>
          {" / "}Inquire
        </p>
        ...
        <div>
            ...
            {[
              {
                ...
                label: "Clear",
                sub: "Transparent",
                swatch: "bg-white border-2 border-[#DCDAD5]",
              },
              {
                id: "neon-green",
                label: "Neon Green",
              ...
              },
              {
                ...
                label: "Custom",
                sub: "Your choice",
                swatch: "bg-gradient-to-b from-[#2222FF] to-[#FF2B78]",
              },
            ].map((opt) => (
              <button
                key={opt.id}
                ...
                onClick={() => {
                  setColour(opt.id);
                  if (opt.id !== "custom") setColourCustom("");
                }}
              ...
              >
                ...
                <div className="text-center">
                  <p className={`text-[0.75rem] font-bold tracking-[0.04em] ${colour === opt.id ? "text-[#2222FF]" : "text-[#0A0A0A]"}`}>
                    {opt.label}
                  </p>
                  <p className="text-[0.6rem] tracking-[0.08em] text-[#888] uppercase mt-0.5">
                    {opt.sub}
                  </p>
                </div>
              </button>
          ...
          {colour === "custom" && (
            <div className="mt-5">
              <textarea
                value={colourCustom}
                onChange={(e) => setColourCustom(e.target.value)}
                placeholder="Describe your preferred colour…"
                rows={3}
